...
app.service('parseService', function($http, $q){
  ...
  //Make sure that in your post request, the format of the data you sent to parse is an object with
  //a key of text and a value of whatever the message was. 
  //IE {text: message}
  ...
  /*
  //Because of the way parse sends back their d.then(function(data){
      deferred.resolve(data.data.results)
    });ata, let's resolve our promise with data.data.results
  //if you had the original parameter be date like below.
  /* 
    .then(function(data){
      deferred.resolve(data.data.results)
    })
